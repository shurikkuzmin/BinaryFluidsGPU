					...
					__global float* rho)
{
	...
	int k=gx+gy*nx;
   	...
   	float g=-1.0, tau = 1.0f;
	float t=4.0/7.0*0.99;
	...
	if(lx==0)
	{
		fx[k]=1.0/9.0*(sqrt(6.0/g*shared_rho[1]*(t/(1.0-2.0/21.0*shared_rho[1])-9.0/49.0*shared_rho[1]-1.0/3.0))
				-sqrt(6.0/g*rhofirst*(t/(1.0-2.0/21.0*rhofirst)-9.0/49.0*rhofirst-1.0/3.0)))
		     +1.0/36.0*(sqrt(6.0/g*shared_rhon[1]*(t/(1.0-2.0/21.0*shared_rhon[1])-9.0/49.0*shared_rhon[1]-1.0/3.0))
				-sqrt(6.0/g*rhofirstup*(t/(1.0-2.0/21.0*rhofirstup)-9.0/49.0*rhofirstup-1.0/3.0))
				-sqrt(6.0/g*rhofirstdown*(t/(1.0-2.0/21.0*rhofirstdown)-9.0/49.0*rhofirstdown-1.0/3.0))
				+sqrt(6.0/g*shared_rhos[1]*(t/(1.0-2.0/21.0*shared_rhos[1])-9.0/49.0*shared_rhos[1]-1.0/3.0)));

		fy[k]=1.0/9.0*(sqrt(6.0/g*shared_rhon[lx]*(t/(1.0-2.0/21.0*shared_rhon[lx])-9.0/49.0*shared_rhon[lx]-1.0/3.0))
				-sqrt(6.0/g*shared_rhos[lx]*(t/(1.0-2.0/21.0*shared_rhos[lx])-9.0/49.0*shared_rhos[lx]-1.0/3.0)))
		     +1.0/36.0*(sqrt(6.0/g*shared_rhon[1]*(t/(1.0-2.0/21.0*shared_rhon[1])-9.0/49.0*shared_rhon[1]-1.0/3.0))
				+sqrt(6.0/g*rhofirstup*(t/(1.0-2.0/21.0*rhofirstup)-9.0/49.0*rhofirstup-1.0/3.0))
				-sqrt(6.0/g*rhofirstdown*(t/(1.0-2.0/21.0*rhofirstdown)-9.0/49.0*rhofirstdown-1.0/3.0))
				-sqrt(6.0/g*shared_rhos[1]*(t/(1.0-2.0/21.0*shared_rhos[1])-9.0/49.0*shared_rhos[1]-1.0/3.0)));
	...
	{
		fx[k]=1.0/9.0*(sqrt(6.0/g*rholast*(t/(1.0-2.0/21.0*rholast)-9.0/49.0*rholast-1.0/3.0))
				-sqrt(6.0/g*shared_rho[BLOCK_SIZE-2]*(t/(1.0-2.0/21.0*shared_rho[BLOCK_SIZE-2])-9.0/49.0*shared_rho[BLOCK_SIZE-2]-1.0/3.0)))
		     +1.0/36.0*(sqrt(6.0/g*rholastup*(t/(1.0-2.0/21.0*rholastup)-9.0/49.0*rholastup-1.0/3.0))
				-sqrt(6.0/g*shared_rhon[BLOCK_SIZE-2]*(t/(1.0-2.0/21.0*shared_rhon[BLOCK_SIZE-2])-9.0/49.0*shared_rhon[BLOCK_SIZE-2]-1.0/3.0))
				-sqrt(6.0/g*shared_rhos[BLOCK_SIZE-2]*(t/(1.0-2.0/21.0*shared_rhos[BLOCK_SIZE-2])-9.0/49.0*shared_rhos[BLOCK_SIZE-2]-1.0/3.0))
				+sqrt(6.0/g*rholastdown*(t/(1.0-2.0/21.0*rholastdown)-9.0/49.0*rholastdown-1.0/3.0)));
	...
	{
		fx[k]=1.0/9.0*(sqrt(6.0/g*shared_rho[right]*(t/(1.0-2.0/21.0*shared_rho[right])-9.0/49.0*shared_rho[right]-1.0/3.0))
				-sqrt(6.0/g*shared_rho[left]*(t/(1.0-2.0/21.0*shared_rho[left])-9.0/49.0*shared_rho[left]-1.0/3.0)))
		     +1.0/36.0*(sqrt(6.0/g*shared_rhon[right]*(t/(1.0-2.0/21.0*shared_rhon[right])-9.0/49.0*shared_rhon[right]-1.0/3.0))
				-sqrt(6.0/g*shared_rhon[left]*(t/(1.0-2.0/21.0*shared_rhon[left])-9.0/49.0*shared_rhon[left]-1.0/3.0))
				-sqrt(6.0/g*shared_rhos[left]*(t/(1.0-2.0/21.0*shared_rhos[left])-9.0/49.0*shared_rhos[left]-1.0/3.0))
				+sqrt(6.0/g*shared_rhos[right]*(t/(1.0-2.0/21.0*shared_rhos[right])-9.0/49.0*shared_rhos[right]-1.0/3.0)));
	...
	fx[k]*=-g*sqrt(6.0/g*rho[k]*(t/(1.0-2.0/21.0*rho[k])-9.0/49.0*rho[k]-1.0/3.0));
	fy[k]*=-g*sqrt(6.0/g*rho[k]*(t/(1.0-2.0/21.0*rho[k])-9.0/49.0*rho[k]-1.0/3.0));
